...
![Subscribe to Calendar](/public/images/pages/creating-event/subscribe.png)

### Step 3: Submit an Event
Click on "Submit Event":
![Submit Event](/public/images/pages/creating-event/submit.png)
...
![Add Host](/public/images/pages/creating-event/host.png)